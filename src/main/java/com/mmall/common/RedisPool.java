...
public class RedisPool {
    ...
    private static Integer maxIdle = Integer.parseInt(PropertiesUtil.getProperty("redis.max.idle","20"));//在jedispool中最大的idle状态(空闲的)jedis实例的个数
    private static Integer minIdle = Integer.parseInt(PropertiesUtil.getProperty("redis.min.idle","20"));//在jedispool中最小的idle状态(空闲的)jedis实例的个数
    ...
    private static void initPool(){
        ...
        config.setBlockWhenExhausted(true); //连接耗尽的时候,是否阻塞,false会抛出异常,true阻塞直到超时,默认true;
